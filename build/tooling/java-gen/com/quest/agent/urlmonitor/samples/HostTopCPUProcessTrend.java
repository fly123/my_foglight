 ...
 * the HostTopCPUProcessTrend topology object.
 * <p/>
...
public class HostTopCPUProcessTrend
    extends HostTopCPUProcessEntry
{

    public final static String NODE_NAME = "HostTopCPUProcessTrend";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public HostTopCPUProcessTrend(String processId, String name) {
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("HostTopCPUProcessTrend");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new HostTopCPUProcessTrend(getProcessId(), getName());
    }
