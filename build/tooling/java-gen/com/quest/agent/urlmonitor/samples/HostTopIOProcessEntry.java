 ...
 * the HostTopIOProcessEntry topology object.
 * <p/>
...
public class HostTopIOProcessEntry
    extends HostTopProcessEntry
{

    public final static String NODE_NAME = "HostTopIOProcessEntry";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;
    private Float _ioRate;

    public HostTopIOProcessEntry(String processId, String name) {
        ...
        throws TopologyException
    {
        ...
        if (!(_ioRate == null)) {
            final TopologyValue _value78 = currentNode.createValue("ioRate");
            _value78 .setSampleValue(_ioRate, unitService.getUnits("byte/second"));
            if (__isIdentity("ioRate")) {
                _value78 .setIsIdentity(true);
            }
        }
    }
    ...
    /**
     * Returns the current value of the 'ioRate' property.
     * 
     * @return
     *     The current value of the 'ioRate' property.
     */
    ...
    /**
     * Sets the current value of the 'ioRate' property.
     * 
     */
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("HostTopIOProcessEntry");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new HostTopIOProcessEntry(getProcessId(), getName());
    }
