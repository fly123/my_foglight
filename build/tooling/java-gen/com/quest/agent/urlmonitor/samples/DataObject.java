 ...
 * the DataObject topology object.
 * <p/>
...
public class DataObject
    extends com.quest.agent.urlmonitor.samples.Object
{

    public final static String NODE_NAME = "DataObject";
        ...
        throws TopologyException
    {
        ...
        if (!(_uniqueId == null)) {
            final TopologyValue _value221 = currentNode.createValue("uniqueId");
            _value221 .setSampleValue(_uniqueId.toString());
            if (__isIdentity("uniqueId")) {
                _value221 .setIsIdentity(true);
            }
        }
    }
    ...
    /**
     * Returns the current value of the 'uniqueId' property.
     * 
     * @return
     *     The current value of the 'uniqueId' property.
     */
    ...
    /**
     * Sets the current value of the 'uniqueId' property.
     * 
     */
