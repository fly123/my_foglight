 ...
 * the HostTopCPUProcessEntry topology object.
 * <p/>
...
public class HostTopCPUProcessEntry
    extends HostTopProcessEntry
{

    public final static String NODE_NAME = "HostTopCPUProcessEntry";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;
    private Float _cpuUsage;

    public HostTopCPUProcessEntry(String processId, String name) {
        ...
        throws TopologyException
    {
        ...
        if (!(_cpuUsage == null)) {
            final TopologyValue _value139 = currentNode.createValue("cpuUsage");
            _value139 .setSampleValue(_cpuUsage, unitService.getUnits("percent"));
            if (__isIdentity("cpuUsage")) {
                _value139 .setIsIdentity(true);
            }
        }
    }
    ...
    /**
     * Returns the current value of the 'cpuUsage' property.
     * 
     * @return
     *     The current value of the 'cpuUsage' property.
     */
    ...
    /**
     * Sets the current value of the 'cpuUsage' property.
     * 
     */
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("HostTopCPUProcessEntry");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new HostTopCPUProcessEntry(getProcessId(), getName());
    }
