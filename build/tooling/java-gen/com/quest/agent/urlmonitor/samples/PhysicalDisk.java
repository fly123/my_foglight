 ...
 * the PhysicalDisk topology object.
 * <p/>
    ...
    extends SecondaryStorage
{
    ...
    public final static String NODE_NAME = "PhysicalDisk";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public PhysicalDisk(String name, Host host) {
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new PhysicalDisk(getName(), getHost());
    }
