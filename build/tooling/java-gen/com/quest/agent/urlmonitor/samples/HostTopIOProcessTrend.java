 ...
 * the HostTopIOProcessTrend topology object.
 * <p/>
...
public class HostTopIOProcessTrend
    extends HostTopIOProcessEntry
{

    public final static String NODE_NAME = "HostTopIOProcessTrend";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public HostTopIOProcessTrend(String processId, String name) {
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("HostTopIOProcessTrend");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new HostTopIOProcessTrend(getProcessId(), getName());
    }
