 ...
 * the LogicalDisk topology object.
 * <p/>
...
public class LogicalDisk
    extends SecondaryStorage
{

    public final static String NODE_NAME = "LogicalDisk";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public LogicalDisk(String name, Host host) {
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new LogicalDisk(getName(), getHost());
    }
