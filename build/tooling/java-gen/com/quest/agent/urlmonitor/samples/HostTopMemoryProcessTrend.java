 ...
 * the HostTopMemoryProcessTrend topology object.
 * <p/>
...
public class HostTopMemoryProcessTrend
    extends HostTopMemoryProcessEntry
{

    public final static String NODE_NAME = "HostTopMemoryProcessTrend";
    public final UUID NODE_ID = UUID.randomUUID();
    private boolean _resetting = false;

    public HostTopMemoryProcessTrend(String processId, String name) {
    ...
    public String toString() {
        ...
        builder.append("[");
        builder.append("HostTopMemoryProcessTrend");
        builder.append("@");
    ...
    protected java.lang.Object __cloneIdOnly() {
        return new HostTopMemoryProcessTrend(getProcessId(), getName());
    }
