...
/**
 * This class contains the unit tests for the URLMonitorAgent agent. Although the agent 
 ...
 */
public class TestURLMonitorAgentImpl {

private URLMonitorAgentImpl mAgent;
...
public void initTest() throws ServiceFactory.ServiceNotAvailableException {
    ...
    mAgent = new URLMonitorAgentImpl(serviceFactory, mMockProvider);
}
 ...
 * provide a mockup of the {@link URLMonitorAgentDataProvider} interface.
 */
private static final class MockDataProvider implements URLMonitorAgentDataProvider {
