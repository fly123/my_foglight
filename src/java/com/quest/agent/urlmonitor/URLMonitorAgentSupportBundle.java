...
/**
 * A class that can contribute information about the URLMonitorAgent to 
 * any support bundle that is generated.
 */
public class URLMonitorAgentSupportBundle implements SupportBundleListener {

/** A reference to the main agent class so we can collect information from it */
private final URLMonitorAgentImpl mURLMonitorAgent;

/**
 * Creates a new support bundle contributer.
 */
public URLMonitorAgentSupportBundle(URLMonitorAgentImpl agent) {
    mURLMonitorAgent = agent;
}
...
public String getSuggestedLocation() { 
    return "URLMonitorAgent" + File.separator + "info.txt";
}
...
public String getCollectorName() {
    return "URLMonitorAgent information";
}
...
public void collectText(OutputStream output) throws Exception {
    ...
    out.println("The URLMonitorAgent has something to say");
}
